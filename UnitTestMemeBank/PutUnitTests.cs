...
namespace UnitTestMemeBank
{
    ...
    {
        public static readonly DbContextOptions<MemeAPIContext> options = new DbContextOptionsBuilder<MemeAPIContext>().UseInMemoryDatabase(databaseName: "testDatabase").Options;
